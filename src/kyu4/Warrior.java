 ...
 *
 * https://www.codewars.com/kata/5941c545f5c394fef900000c/java
 *
...
public class Warrior {
    ...
    String getFightResult(int enemyLvl_) {
        ...
        if (level - enemyLvl_ <= -5 && !isWarriorsSameRank(level, enemyLvl_)) {
            return "You've been defeated";
        }
        if (level < enemyLvl_) {
            experience += 20 * (enemyLvl_ - level) * (enemyLvl_ - level);
    ...
    int experience() {
        return Math.min(experience, 10000);
    }
